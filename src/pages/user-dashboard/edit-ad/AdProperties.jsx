...
export default function AdProperties({ ad }) {
    ...
    return Object.entries(sharedProperties).map(
      ([key, { label, Icon, getValue, condition }]) => {
        ...
        return (
          <li
            key={key}
            className="item mt-3 col-xl-3 col-md-4 col-sm-6 col-xs-6 d-flex align-items-center gap-3 "
          >
            <a className="box-icon border rounded-3 w-52 text-dark">
              <Icon />
            </a>
      ...
      ({ key, label, Icon, format, detailsKeyIndex = 0 }) => {
        ...
        return (
          <li
            ...
            className="item mt-3 col-xl-3 col-md-4 col-sm-6 col-xs-6 d-flex align-items-center gap-3"
          >
            <a className="box-icon border rounded-3 p-2 w-52 text-dark">
              <Icon />
            </a>
            <div className="d-flex flex-column">
              <span className="label text-variant-1">{label}</span>
